				...
				return (
					<div key={step.title} className='flex flex-1 items-center'>
						<div className='relative flex flex-col items-center'>
							<div
								className={cn('flex h-8 w-8 items-center justify-center rounded-full border-2', {
							...
							<span className='absolute -bottom-6 w-max text-sm'>{step.title}</span>
						</div>
						{index < steps.length - 1 && (
							<div
								className={cn('mx-4 h-[2px] flex-1', {
